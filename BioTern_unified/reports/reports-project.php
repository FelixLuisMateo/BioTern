...
.report-filter-check { display: flex; align-items: center; min-height: 40px; padding-top: 1.35rem; }
...
.progress-bar-custom .bar { height: 100%; background: linear-gradient(90deg, #10b981, #059669); }
...
html.app-skin-dark .report-filter-wrap .form-label,
html.app-skin-dark .report-filter-wrap .form-check-label { color: #9fb0d3; }
...
@media (max-width: 768px) { .report-filter-field { min-width: 100%; max-width: none; flex-basis: 100%; } .report-filter-check { padding-top: 0; min-height: auto; } }
</style>
<div class="page-header">
    <div class="page-header-left d-flex align-items-center">
        <div class="page-header-title">
            <h5 class="m-b-10">Project Report</h5>
            <ul class="breadcrumb">
...
<div>
<h6 class="mb-1 fw-bold">Project Activity Overview</h6>
<p class="text-muted mb-0">Track internship placements, company assignments, and student activity across every active project.</p>
</div>
