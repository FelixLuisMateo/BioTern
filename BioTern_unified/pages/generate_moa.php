...
<div class="container app-moa-container">
    <div class="doc app-moa-doc" id="moa_doc_content">
        ...
        <p class="and-line app-moa-and-line center-neg-20 app-moa-center-neg-20">
            And 
        </p>
...
<script>
    (function () {
        ...
        document.body.dataset.useSavedTemplate = <?php echo json_encode($use_saved_template ? '1' : '0', JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
    })();
</script>
</div>
