...
<style>
.tools-shell{display:grid;grid-template-columns:minmax(220px,280px) minmax(0,1fr);gap:20px}.tools-sidebar,.tools-panel{background:rgba(19,28,51,.92);border:1px solid rgba(138,155,188,.18);border-radius:18px}.tools-sidebar{padding:18px;align-self:start}.tools-nav-title{font-size:11px;letter-spacing:.18em;text-transform:uppercase;color:var(--bs-secondary-color);margin-bottom:14px}.tools-nav{display:grid;gap:8px}.tools-nav a{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:11px 13px;border-radius:12px;text-decoration:none;color:inherit;border:1px solid rgba(138,155,188,.14);background:rgba(79,70,229,.06)}.tools-nav a.active{background:rgba(79,70,229,.14);border-color:rgba(79,70,229,.38);color:#fff}.tools-panel{padding:20px}.excel-import-shell{max-width:none;margin:0 auto}.excel-import-hero{background:rgba(79,70,229,.08);color:inherit;border:1px solid rgba(138,155,188,.18);border-radius:18px;box-shadow:none}.excel-import-hero h2,.excel-import-card h4,.excel-import-card h5,.excel-import-card h6{color:#fff}.excel-import-hero p,.excel-import-card .text-muted,.excel-import-card .form-text{color:#aab8c5!important}.excel-import-badge{background:rgba(79,70,229,.12);color:#7c9dff}.excel-import-card{background:rgba(19,28,51,.92);border-color:rgba(138,155,188,.18);border-radius:18px;box-shadow:none}.excel-import-step,.excel-import-stat,.excel-import-section-link,.excel-import-chip,.excel-import-chip-clear,.excel-import-results-empty{background:rgba(79,70,229,.04);border-color:rgba(138,155,188,.14)}.excel-import-stat-value{color:#7c9dff}.excel-import-chip,.excel-import-chip-clear{color:#dbe7ff}.excel-import-chip.active,.excel-import-section-link.active{background:rgba(79,70,229,.18);border-color:rgba(79,70,229,.38)}.excel-import-card .form-control,.excel-import-card .form-select{background:#131b33;border-color:rgba(138,155,188,.24);color:#fff}.excel-import-card .form-control[type="file"]{padding:0;background:#131b33;color:#edf4fb}.excel-import-card .form-control[type="file"]::file-selector-button,.excel-import-card .form-control[type="file"]::-webkit-file-upload-button{margin:0 12px 0 0;padding:12px 16px;border:0;border-right:1px solid rgba(138,155,188,.24);background:#243244!important;color:#edf4fb!important;font-weight:600;-webkit-appearance:none;appearance:none}.excel-import-card .btn-light{background:#243244;border-color:#334354;color:#edf4fb}.compact-section{margin-top:16px!important}.compact-card-body{padding:20px!important}.compact-hero-body{padding:24px!important}.compact-toolbar{margin-bottom:12px!important}.compact-toolbar h4,.compact-toolbar h5{margin-top:10px!important;margin-bottom:8px!important}html:not(.app-skin-dark) .tools-sidebar,html:not(.app-skin-dark) .tools-panel,html:not(.app-skin-dark) .excel-import-card{background:#fff;border-color:rgba(71,103,255,.12);color:#1f2937}html:not(.app-skin-dark) .tools-nav-title{color:#8a94a6}html:not(.app-skin-dark) .tools-nav a{background:#f7f9ff;border-color:rgba(71,103,255,.12);color:#334155}html:not(.app-skin-dark) .tools-nav a.active{background:rgba(82,109,254,.1);border-color:rgba(82,109,254,.3);color:#1d4ed8}html:not(.app-skin-dark) .excel-import-hero,html:not(.app-skin-dark) .excel-import-step,html:not(.app-skin-dark) .excel-import-stat,html:not(.app-skin-dark) .excel-import-section-link,html:not(.app-skin-dark) .excel-import-chip,html:not(.app-skin-dark) .excel-import-chip-clear,html:not(.app-skin-dark) .excel-import-results-empty{background:#f7f9ff;border-color:rgba(71,103,255,.12);color:#334155}html:not(.app-skin-dark) .excel-import-hero h2,html:not(.app-skin-dark) .excel-import-card h4,html:not(.app-skin-dark) .excel-import-card h5,html:not(.app-skin-dark) .excel-import-card h6{color:#0f172a}html:not(.app-skin-dark) .excel-import-hero p,html:not(.app-skin-dark) .excel-import-card .text-muted,html:not(.app-skin-dark) .excel-import-card .form-text{color:#64748b!important}html:not(.app-skin-dark) .excel-import-badge,html:not(.app-skin-dark) .excel-import-stat-value{color:#4f46e5}html:not(.app-skin-dark) .excel-import-card .form-control,html:not(.app-skin-dark) .excel-import-card .form-select{background:#fff;border-color:rgba(148,163,184,.35);color:#0f172a}html:not(.app-skin-dark) .excel-import-card .form-control[type="file"]{background:#fff;color:#0f172a}html:not(.app-skin-dark) .excel-import-card .form-control[type="file"]::file-selector-button,html:not(.app-skin-dark) .excel-import-card .form-control[type="file"]::-webkit-file-upload-button{background:#eef2ff!important;border-right-color:rgba(148,163,184,.35);color:#1d4ed8!important}html:not(.app-skin-dark) .excel-import-card .btn-light{background:#eef2ff;border-color:rgba(148,163,184,.35);color:#1d4ed8}@media (max-width:1199.98px){.tools-shell{grid-template-columns:1fr}}@media (max-width:767.98px){.tools-panel{padding:16px}.compact-card-body,.compact-hero-body{padding:18px!important}}
</style>
    ...
    <div class="main-content">
        <div class="tools-shell">
            <aside class="tools-sidebar">
                ...
                <nav class="tools-nav">
                    <a href="import-students-excel.php" class="active"><span>Excel Import</span><i class="feather-arrow-right"></i></a>
                    <a href="import-sql.php"><span>Data Transfer</span><i class="feather-arrow-right"></i></a>
