...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/favicon.ico?v=20260310') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/layout-shared-overrides.css') }}">
    <style>
        .time-cell {
