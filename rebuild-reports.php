...
// Generation of the OJT/Project/Timesheets unified report files has been disabled
// to avoid recreating pages that were intentionally removed.
echo "Report generation disabled for removed report pages.\n";
OJTEOT;
