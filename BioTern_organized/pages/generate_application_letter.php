...
<div class="container">
    ...
    <div class="actions no-print" style="margin-top:12px; display:flex; gap:8px; flex-wrap:wrap; align-items:center;">
        <div class="alert alert-info small" role="alert" style="flex:1 1 100%;">
            Tip: To remove the headers and footers (date / URL) from the PDF, uncheck "Headers and footers" or "Include headers and footers" in your browser's print dialog (Chrome/Edge: More settings â†’ uncheck "Headers and footers").
        </div>
