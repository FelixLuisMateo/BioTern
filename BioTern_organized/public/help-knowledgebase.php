...
<body>
                ...
                <ul class="nxl-navbar">
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            ...
                            <li class="nxl-item"><a class="nxl-link" href="">OJT Report</a></li>
                    ...
                    <li class="nxl-item nxl-hasmenu">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="">Students</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="">Students View</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="">Students Create</a></li>
                        </ul>
                    </li>
                    <li class="nxl-item nxl-hasmenu">
                        <a href="javascript:void(0);" class="nxl-link">
                        ...
                        <ul class="nxl-submenu">
                            <li class="nxl-item"><a class="nxl-link" href="../management/ojt.php">OJT List</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="">OJT View</a></li>
                            <li class="nxl-item"><a class="nxl-link" href="">OJT Create</a></li>
                        </ul>
                    </li>
    ...
    <!--! ================================================================ !-->
    <!--! ================================================================ !-->
    <!--! BEGIN: Topics Details Offcanvas !-->
    <!--! ================================================================ !-->
    <div class="offcanvas offcanvas-end topics-details-offcanvas" tabindex="-1" id="topicsDetailsOffcanvas" aria-labelledby="topicsDetailsOffcanvas">
        <div class="offcanvas-header border-bottom px-4">
            <div class="d-flex">
                ...
                <span class="mx-2 text-muted">/</span>
                <div class="text-muted">Integration</div>
            </div>
        ...
        <div class="offcanvas-body">
            <div class="p-lg-5 mx-lg-5 help-center details-content-body">
                ...
                <ul class="text-muted my-4">
                    ...
                    <li class="mb-2"><strong class="text-dark">Fine-tune</strong> your notifications to focus on that matters</li>
