    ...
    <div class="nxl-content">
        <div class="page-header">
            ...
            <div class="page-header-right ms-auto d-flex gap-2">
                ...
                <a href="" class="btn btn-outline-primary"><i class="feather-kanban me-1"></i>Workflow Board</a>
                ...
                <a href="" class="btn btn-primary"><i class="feather-plus me-1"></i>New OJT Assignment</a>
            </div>
        </div>
