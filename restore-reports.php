<?php
// Restoration script for corrupted report files
error_reporting(E_ALL);
ini_set('display_errors', 1);

$base_path = __DIR__ . '/BioTern_unified/reports/';
...
// Write files
$files = [
    'reports-ojt.php' => $ojt_content,
    'reports-project.php' => $project_content,
    'reports-timesheets.php' => $timesheets_content,
];
...
foreach ($files as $filename => $content) {
    ...
    $results[$filename] = $bytes_written ? "✓ {$filename} restored ({$bytes_written} bytes)" : "✗ {$filename} failed";
}

header('Content-Type: text/plain; charset=utf-8');
echo "Report File Restoration Results:\n";
echo "================================\n\n";
foreach ($results as $name => $result) {
    echo $result . "\n";
}
echo "\n✓ All reports have been restored successfully!\n";
echo "Access reports at: Reports menu\n";
?>
