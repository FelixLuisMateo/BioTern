...
<head>
    ...
    <style>
        ...
        .doc h4 { text-align:center; margin:10px 0; font-size: 12pt; font-weight: 700; }
...
<div class="container">
    ...
    <div class="doc">
        ...
        <p>
            This Memorandum of Agreement made and executed between: <strong>CLARK COLLEGE OF SCIENCE AND TECHNOLOGY</strong> a Higher Education Institution, duly organized and existing under Philippine Laws with office/business address at <strong>AUREA ST. SAMSONVILLE, DAU MABALACAT CITY PAMPANGA</strong> represented herein by <strong>MR. JOMAR G. SANGIL (IT, DEPARTMENT HEAD)</strong>, hereinafter referred to as the Higher Education Institution.
        </p>
        <p style="text-align:center; margin-top:-20px; margin-bottom:10px;">
            And 
        </p>
        <strong><?php echo htmlspecialchars($partner_name); ?></strong> an enterprise duly organized and existing under Philippine Laws with office/business address at <strong><?php echo htmlspecialchars($partner_address); ?></strong> represented herein by <strong><?php echo htmlspecialchars($partner_rep); ?></strong> here in after referred to as the PARTNER COMPANY.
        <p style="text-align:center;">Witnesseth:</p>
        ...
        <p>In witness whereof the parties have signed this Memorandum of Agreement at <?php echo htmlspecialchars($signed_at); ?> this <?php echo htmlspecialchars($signed_day); ?> day of <?php echo htmlspecialchars($signed_month); ?>, <?php echo htmlspecialchars($signed_year); ?>.</p>
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col">
                ...
                <p style="margin-top:-18px;"><?php echo htmlspecialchars($partner_position); ?></p>
            </div>
            <div class="col right">
        ...
        <p style="margin-top:10px; text-align:center;"><strong>SIGNED IN THE PRESENCE OF:</strong></p>
        <div class="row">
            <div class="col">
        ...
        <p style="margin-top:18px;"><strong>ACKNOWLEDGEMENT</strong></p>
        <p>
        ...
        <p>Doc No. <?php echo htmlspecialchars($doc_no); ?>:</p>
        <p>Page No. <?php echo htmlspecialchars($page_no); ?>:</p>
        <p>Book No. <?php echo htmlspecialchars($book_no); ?>:</p>
        <p>Series of <?php echo htmlspecialchars($series_no); ?>:</p>
    </div>
