                ...
                <div class="col-lg-6 doc-template-pane">
                    ...
                    <div class="doc-preview" id="moa_preview">
                        <div id="moa_content" class="a4-pages-stack">
                            ...
                            And<br>
                            <strong><span id="pv_partner_company_name" class="moa-fill-line">__________________________</span></strong> a LOCAL GOVERNMENT UNIT duly organized and existing under Philippine Laws with office/ business address at <strong><span id="pv_partner_address" class="moa-fill-line">__________________________</span></strong>represented herein by <strong><span id="pv_partner_name" class="moa-fill-line">__________________________</span></strong> herein after referred to as the PARTNER LOCAL GOVERNMENT UNIT.</p>
                            <p>Barangay Receipt / Ref.: <span id="pv_company_receipt" class="moa-fill-line">__________________________</span></p>
                            Witnesseth: <br><br>
