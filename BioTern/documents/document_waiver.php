...
<body>
    ...
    <p>I, <strong class="waiver-fill-line"><?php echo htmlspecialchars($student_name !== '' ? $student_name : ''); ?></strong>, voluntarily agree to participate in internship activities under the guidance of the institution and assigned supervisors.</p>
