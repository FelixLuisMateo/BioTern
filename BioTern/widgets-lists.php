...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>BioTern || Widgets Lists</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                            ...
                            <div class="card-body custom-card-action">
                                ...
                                <div class="w-100 d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="javascript:void(0)" class="d-flex align-items-center mb-1">Felix Luis Mateo</a>
                            ...
                            <div class="card-body custom-card-action">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3 align-items-end">
                                        <img src="../assets/images/payment/mastercard.svg" alt="" class="img-fluid wd-50">
                                        <div class="ac-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3 align-items-end">
                                        <img src="../assets/images/payment/visa.svg" alt="" class="img-fluid wd-50">
                                        <div class="ac-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3 align-items-end">
                                        <img src="../assets/images/payment/discover.svg" alt="" class="img-fluid wd-50">
                                        <div class="ac-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3 align-items-end">
                                        <img src="../assets/images/payment/american-express.svg" alt="" class="img-fluid wd-50">
                                        <div class="ac-card">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="hstack gap-3 align-items-end">
                                        <img src="../assets/images/payment/jcb.svg" alt="" class="img-fluid wd-50">
                                        <div class="ac-card">
                            ...
                            <div class="card-body custom-card-action">
                                <ul class="list-unstyled mb-0 activity-feed-1">
                                    <li class="feed-item feed-item-primary">
                                        <div class="d-flex gap-4 justify-content-between">
                                            <div>
                                                ...
                                                <p class="fs-12 text-muted mb-3 text-truncate-2-line">BioTern is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology's.</p>
                                                <div>
                                    ...
                                    <li class="feed-item feed-item-danger">
                                        <div class="d-flex gap-4 justify-content-between">
                                            <div>
                                                <div class="mb-2 text-truncate-1-line"><a href="javascript:void(0)" class="fw-semibold text-dark">Event start soon #BioTern</a></div>
                                                <p class="fs-12 text-muted mb-3 text-truncate-2-line">BioTern is a clean bootstrap admin dashboard, frontend and webapps template pack that built with most popular bootstrap framework and modern technology's.</p>
                                ...
                                <ul class="list-unstyled activity-feed mb-0">
                                    ...
                                    <li class="d-flex justify-content-between feed-item feed-item-info">
                                        <div>
                                            ...
                                            <span class="text">Joined the group <a href="javascript:void(0);" class="fw-bold text-primary">"BioTern"</a></span>
                                        </div>
                                        <div class="ms-3 d-flex gap-2 align-items-center">
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
                                    ...
                                    <li class="d-flex justify-content-between feed-item feed-item-primary">
                                        <div>
                                            ...
                                            <span class="text">Attending the event <a href="javascript:void(0);" class="fw-bold text-primary">"BioTern Event"</a></span>
                                        </div>
                                        <div class="ms-3 d-flex gap-2 align-items-center">
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
                                    ...
                                    <li class="d-flex justify-content-between feed-item feed-item-danger">
                                        <div>
                                            ...
                                            <span class="text">BioTern meeting <a href="javascript:void(0);" class="badge bg-soft-warning text-warning ms-1">Join</a></span>
                                        </div>
                                        <div class="ms-3 d-flex gap-2 align-items-center">
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Make Read"><i class="feather feather-check fs-12"></i></a>
                                            <a href="javascript:void(0);" class="avatar-text avatar-sm" data-bs-toggle="tooltip" data-bs-trigger="hover" title="View Activity"><i class="feather feather-eye fs-12"></i></a>
                        ...
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    ...
                                    <div class="mb-4">
                                        <a href="javascript:void(0);" class="fs-14 fw-bold d-block"> Felix Luis Mateo</a>
                                        <a href="javascript:void(0);" class="fs-12 fw-normal text-muted d-block">felixluismateo@example.com</a>
                                    </div>
                                ...
                                <ul class="list-unstyled mb-4">
                                    ...
                                    <li class="hstack justify-content-between mb-0">
                                        ...
                                        <a href="javascript:void(0);" class="float-end">felixluismateo@example.com</a>
                                    </li>
                                </ul>
                        ...
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <div class="d-flex align-items-center mb-4 pb-2">
                                    ...
                                    <a href="#!"  class="text-truncate-1-line">https://www.facebook.com/<span class="text-gray-500">theme_ocean</span></a>
                                ...
                                <div class="d-flex align-items-center mb-4 pb-2">
                                    ...
                                    <span class="mx-2 text-gray-400">/</span>
                                    <a target="_blank" href="https://www.twitter.com/theme_ocean"  class="text-truncate-1-line">https://www.twitter.com/<span class="text-gray-500">theme_ocean</span></a>
                                ...
                                <div class="d-flex align-items-center mb-4 pb-2">
                                    ...
                                    <span class="mx-2 text-gray-400">/</span>
                                    <a target="_blank" href="https://www.github.com/theme_ocean"  class="text-truncate-1-line">https://www.github.com/<span class="text-gray-500">theme_ocean</span></a>
                                ...
                                <div class="d-flex align-items-center mb-4 pb-2">
                                    ...
                                    <span class="mx-2 text-gray-400">/</span>
                                    <a target="_blank" href="https://www.linkedin.com/theme_ocean"  class="text-truncate-1-line">https://www.linkedin.com/<span class="text-gray-500">theme_ocean</span></a>
                                ...
                                <div class="d-flex align-items-center mb-4 pb-2">
                                    ...
                                    <span class="mx-2 text-gray-400">/</span>
                                    <a target="_blank" href="https://www.gitlab.com/theme_ocean"  class="text-truncate-1-line">https://www.gitlab.com/<span class="text-gray-500">theme_ocean</span></a>
                                ...
                                <div class="d-flex align-items-center mb-0 pb-2">
                                    ...
                                    <span class="mx-2 text-gray-400">/</span>
                                    <a target="_blank" href="https://www.figma.com/theme_ocean"  class="text-truncate-1-line">https://www.figma.com/<span class="text-gray-500">theme_ocean</span></a>
                            ...
                            <div class="card-body custom-card-action">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            <h5 class="fs-13 mb-1">Felix Luis Mateo</h5>
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);">BioTern public pnnouncement <span class="fs-12 fw-normal text-muted">(20/02/2023)</span> </a>
                                                    <p class="fs-12 text-muted text-truncate-1-line tickets-sort-desc">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                                                    <div class="tickets-list-action d-flex align-items-center gap-3">
                                                        <a href="javascript:void(0);">View</a>
                                                        <span>|</span>
                                            ...
                                            <div class="px-3">
                                                ...
                                                <div class="fs-12 mt-3">
                                                    ...
                                                    <div class="hstack gap-2 text-muted mb-2">
                                                        ...
                                                        <span class="text-truncate-1-line">support@theme_ocean.com</span>
                                                    </div>
