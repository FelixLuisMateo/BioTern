...
$map = [
  ...
  'generate_resume.php' => 'documents/document_resume.php',
...
if ($is_logged_in) {
  ...
  $internship_files = [
    ...
    'demo-biometric.php', 'fingerprint_mapping.php', 'biometric-machine.php', 'bridge-setup-manual.php', 'biometric_machine_sync.php',
