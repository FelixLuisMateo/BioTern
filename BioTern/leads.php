                                    ...
                                    <table class="table table-hover" id="leadList">
                                        ...
                                        <tbody>
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">felixluismateo@example.com</a></td>
                                                <td>
                                                ...
                                                <td>
                                                    <select class="form-control" data-select2-selector="status">
                                                        ...
                                                        <option value="teal" data-bg="bg-teal">Student</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">nancy.elliot@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                                            <i class="feather-facebook"></i>
                                                ...
                                                <td>
                                                    <select class="form-control" data-select2-selector="status">
                                                        ...
                                                        <option value="success" data-bg="bg-success">Qualified</option>
                                                        <option value="danger" data-bg="bg-danger">Declined</option>
                                                        <option value="teal" data-bg="bg-teal" selected>Student</option>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">green.cute@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">henry.leach@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">marine.adrey@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">cute.green@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">leach.henry@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                                            <i class="feather-facebook"></i>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">adrey.marine@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                                            <i class="feather-linkedin"></i>
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td><a href="apps-mail.php">elliot.nancy@outlook.com</a></td>
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <div class="avatar-text avatar-sm">
                                                            <i class="feather-twitter"></i>
