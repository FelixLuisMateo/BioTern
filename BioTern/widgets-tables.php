...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>BioTern || Widgets Tables</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge bg-gray-200 text-dark">theme_ocean</span>
                                                </td>
                                                <td>$250.00 USD</td>
                                                <td>
                                                    <span class="badge bg-soft-success text-success">Completed</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="hstack gap-3">
                                                        ...
                                                        <div>
                                                            <a href="javascript:void(0);" class="d-block">Felix Luis Mateo</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="hstack gap-3">
                                                        ...
                                                        <div>
                                                            <div class="fw-bold text-dark">Felix Luis Mateo</div>
