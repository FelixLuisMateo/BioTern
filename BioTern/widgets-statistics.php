...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>BioTern || Widgets Statistics</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
                    ...
                    <div class="col-xxl-3 col-md-6">
                        <div class="card stretch stretch-full">
                            <div class="card-body">
                                ...
                                <div class="pt-4">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <a href="javascript:void(0);" class="fs-12 fw-medium text-muted text-truncate-1-line">Converted OJT </a>
                                        <div class="w-100 text-end">
                    ...
                    <div class="col-xxl-3 col-md-6">
                        <div class="card bg-soft-primary border-soft-primary text-primary overflow-hidden">
                            <div class="card-body">
                                ...
                                <div class="fs-12 text-reset fw-normal">New Students</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-md-6">
