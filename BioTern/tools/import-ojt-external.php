    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO ojt_external
            ...
            ON DUPLICATE KEY UPDATE
                user_id = COALESCE(VALUES(user_id), ojt_external.user_id),
                last_name = VALUES(last_name),
                first_name = VALUES(first_name),
                middle_name = VALUES(middle_name),
                course_id = COALESCE(VALUES(course_id), ojt_external.course_id),
                section_id = COALESCE(VALUES(section_id), ojt_external.section_id),
                email = VALUES(email),
        ...
        $existingStudentNos = [];
        $existingRes = $conn->query('SELECT student_no, last_name, first_name, middle_name, email FROM ojt_external');
                ...
                <div class="card-body">
                    ...
                    <div class="import-uploader-box">
                        <form method="post" enctype="multipart/form-data" class="row g-2 align-items-end">
                            <div class="col-12 col-md-8">
                                <label class="form-label" for="excel_file">OJT External Excel File</label>
