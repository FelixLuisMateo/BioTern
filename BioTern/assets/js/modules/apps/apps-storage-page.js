...
(() => {
    ...
    function openUploadPanel(file = null, preset = null) {
        ...
        if (file) {
            ...
            els.uploadId.value = '';
            if (els.uploadTitleText) els.uploadTitleText.textContent = 'Add Personal File';
