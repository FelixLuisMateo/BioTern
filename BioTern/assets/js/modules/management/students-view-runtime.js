...
(function () {
  ...
  function initializeInternalEvaluation() {
    ...
    function splitRecommendationLines(text, maxChars, maxLines) {
    ...
    function updatePrintValues() {
      ...
      var recommendationLines = sheet.querySelectorAll(".student-internal-eval-print-line");
      var splitLines = splitRecommendationLines(recommendation ? recommendation.value : "", 94, 4);
      Array.prototype.slice.call(recommendationLines).forEach(function (line, index) {
        line.textContent = splitLines[index] || "";
      });
      saveDraft();
    }
    ...
    function printEvaluation() {
      ...
      doc.write(
        '<!doctype html><html><head><meta charset="utf-8"><title>Internal Evaluation</title>' +
          '<style>@page{size:A4;margin:0}html,body{margin:0;background:#fff}.student-internal-eval-print-sheet{display:block}.student-internal-eval-paper{width:210mm;height:297mm;box-sizing:border-box;padding:12mm 12mm;background:#fff;color:#000;font-family:Arial,sans-serif;font-size:12.8px;line-height:1.2;overflow:hidden}.student-internal-eval-paper--page-1{page-break-after:always;break-after:page}.student-internal-eval-paper--page-2{padding-top:11mm}.student-internal-eval-print-header{display:flex;align-items:center;justify-content:center;gap:20px;border-bottom:2px solid #111;padding:0 12mm 5px 0;margin:0 0 9px}.student-internal-eval-print-header img{width:58px;height:auto;flex:0 0 auto}.student-internal-eval-print-header h2,.student-internal-eval-print-header p{margin:0;text-align:center}.student-internal-eval-print-header>div{min-width:112mm}.student-internal-eval-print-header h2{font-size:14px;font-weight:900;letter-spacing:.02em}.student-internal-eval-print-header p{font-size:8.6px;line-height:1.05}.student-internal-eval-paper h3{margin:9px 0 17px;font-size:13px;line-height:1.15;text-align:center}.student-internal-eval-print-meta{width:46%;margin-bottom:21px}.student-internal-eval-print-meta p{display:grid;grid-template-columns:126px 1fr;gap:8px;margin:4px 0}.student-internal-eval-print-meta span{min-height:15px;border-bottom:1px solid #111}.student-internal-eval-print-purpose{margin:17px 0 15px}.student-internal-eval-print-scale{width:52%;margin:9px auto 17px}.student-internal-eval-print-scale p{display:grid;grid-template-columns:110px 1fr;margin:3px 0}.student-internal-eval-print-part-title{margin:0 0 7px;font-weight:700}.student-internal-eval-print-table{width:100%;margin:0 auto;border-collapse:collapse;font-size:14.2px;line-height:1.32}.student-internal-eval-print-table th,.student-internal-eval-print-table td{border:1px solid #111;padding:7px 8px;vertical-align:top}.student-internal-eval-print-table th{text-align:center;text-transform:uppercase}.student-internal-eval-print-table td:nth-child(2),.student-internal-eval-print-table td:nth-child(3){width:118px;text-align:center}.student-internal-eval-print-group td{font-weight:900;text-transform:uppercase}.student-internal-eval-print-recommendation{width:84%;margin:12px 0 0 13mm}.student-internal-eval-print-recommendation p{margin:0 0 4px}.student-internal-eval-print-lines{display:block;min-height:75px;background:none}.student-internal-eval-print-line{display:block;width:100%;min-height:15px;line-height:18px;padding:0;border-bottom:1px solid #111;white-space:normal;overflow:hidden}.student-internal-eval-print-line+.student-internal-eval-print-line{margin-top:5px}.student-internal-eval-print-line--short{width:66%}.student-internal-eval-print-signature{width:190px;margin:36px 48px 0 auto;padding-top:6px;border-top:1px solid #111;text-align:center}</style>' +
          '</head><body>' +
          clone.innerHTML +
          "</body></html>"
      );
