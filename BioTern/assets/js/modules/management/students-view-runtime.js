    ...
    function printEvaluation() {
      ...
      doc.write(
        '<!doctype html><html><head><meta charset="utf-8"><title>Internal Evaluation</title>' +
          '<style>@page{size:A4;margin:0}html,body{margin:0;background:#fff}.student-internal-eval-print-sheet{display:block}.student-internal-eval-paper{width:210mm;height:297mm;box-sizing:border-box;padding:10mm 16mm;background:#fff;color:#000;font-family:Arial,sans-serif;font-size:9.4px;line-height:1.12;overflow:hidden}.student-internal-eval-paper--page-1{page-break-after:always;break-after:page}.student-internal-eval-paper--page-2{padding-top:8mm}.student-internal-eval-print-header{display:flex;align-items:center;gap:14px;border-bottom:2px solid #111;padding-bottom:4px;margin-bottom:7px}.student-internal-eval-print-header img{width:48px;height:auto}.student-internal-eval-print-header h2,.student-internal-eval-print-header p{margin:0;text-align:center}.student-internal-eval-print-header h2{font-size:12px;font-weight:900}.student-internal-eval-print-header p{font-size:7.8px}.student-internal-eval-paper h3{margin:6px 0 10px;font-size:10.4px;line-height:1.15;text-align:center}.student-internal-eval-print-meta{width:45%;margin-bottom:12px}.student-internal-eval-print-meta p{display:grid;grid-template-columns:92px 1fr;gap:7px;margin:3px 0}.student-internal-eval-print-meta span{min-height:13px;border-bottom:1px solid #111}.student-internal-eval-print-purpose{margin:9px 0 10px}.student-internal-eval-print-scale{width:48%;margin:7px auto 10px}.student-internal-eval-print-scale p{display:grid;grid-template-columns:84px 1fr;margin:2px 0}.student-internal-eval-print-table{width:100%;border-collapse:collapse}.student-internal-eval-print-table th,.student-internal-eval-print-table td{border:1px solid #111;padding:2px 4px;vertical-align:top}.student-internal-eval-print-table th{text-align:center;text-transform:uppercase}.student-internal-eval-print-table td:nth-child(2),.student-internal-eval-print-table td:nth-child(3){width:76px;text-align:center}.student-internal-eval-print-group td{font-weight:900;text-transform:uppercase}.student-internal-eval-print-recommendation{margin-top:12px}.student-internal-eval-print-recommendation p{margin-bottom:8px}.student-internal-eval-print-recommendation div{min-height:54px;white-space:pre-wrap;background-image:repeating-linear-gradient(to bottom,transparent 0,transparent 13px,#111 14px);line-height:14px}.student-internal-eval-print-signature{width:170px;margin:38px 0 0 auto;padding-top:6px;border-top:1px solid #111;text-align:center}</style>' +
          '</head><body>' +
          clone.innerHTML +
          "</body></html>"
      );
