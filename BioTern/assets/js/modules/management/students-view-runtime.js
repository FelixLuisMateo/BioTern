    ...
    function printEvaluation() {
      ...
      doc.write(
        '<!doctype html><html><head><meta charset="utf-8"><title>Internal Evaluation</title>' +
          '<style>@page{size:A4;margin:0}html,body{margin:0;background:#fff}.student-internal-eval-print-sheet{display:block}.student-internal-eval-paper{width:210mm;height:297mm;box-sizing:border-box;padding:12mm 12mm;background:#fff;color:#000;font-family:Arial,sans-serif;font-size:14px;line-height:1.25;overflow:hidden}.student-internal-eval-paper--page-1{page-break-after:always;break-after:page}.student-internal-eval-paper--page-2{padding-top:11mm}.student-internal-eval-print-header{display:flex;align-items:center;gap:18px;border-bottom:2px solid #111;padding-bottom:5px;margin-bottom:12px}.student-internal-eval-print-header img{width:58px;height:auto}.student-internal-eval-print-header h2,.student-internal-eval-print-header p{margin:0;text-align:center}.student-internal-eval-print-header h2{font-size:16px;font-weight:900}.student-internal-eval-print-header p{font-size:10.2px}.student-internal-eval-paper h3{margin:10px 0 18px;font-size:14px;line-height:1.15;text-align:center}.student-internal-eval-print-meta{width:46%;margin-bottom:24px}.student-internal-eval-print-meta p{display:grid;grid-template-columns:126px 1fr;gap:8px;margin:6px 0}.student-internal-eval-print-meta span{min-height:15px;border-bottom:1px solid #111}.student-internal-eval-print-purpose{margin:20px 0 18px}.student-internal-eval-print-scale{width:52%;margin:10px auto 24px}.student-internal-eval-print-scale p{display:grid;grid-template-columns:110px 1fr;margin:5px 0}.student-internal-eval-print-part-title{margin:0 0 7px;font-weight:700}.student-internal-eval-print-table{width:96%;margin:0 auto;border-collapse:collapse;font-size:15px;line-height:1.28}.student-internal-eval-print-table th,.student-internal-eval-print-table td{border:1px solid #111;padding:6px 8px;vertical-align:top}.student-internal-eval-print-table th{text-align:center;text-transform:uppercase}.student-internal-eval-print-table td:nth-child(2),.student-internal-eval-print-table td:nth-child(3){width:112px;text-align:center}.student-internal-eval-print-group td{font-weight:900;text-transform:uppercase}.student-internal-eval-print-recommendation{margin-top:18px}.student-internal-eval-print-recommendation p{margin-bottom:8px}.student-internal-eval-print-recommendation div{min-height:82px;white-space:pre-wrap;background-image:repeating-linear-gradient(to bottom,transparent 0,transparent 18px,#111 19px);line-height:19px}.student-internal-eval-print-recommendation span{display:block;min-height:19px}.student-internal-eval-print-signature{width:190px;margin:78px 58px 0 auto;padding-top:6px;border-top:1px solid #111;text-align:center}</style>' +
          '</head><body>' +
          clone.innerHTML +
          "</body></html>"
      );
