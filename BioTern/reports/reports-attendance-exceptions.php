    ...
    <div class="page-header page-header-with-middle">
        <div class="page-header-left d-flex align-items-center">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item">Attendance Exceptions</li>
            </ul>
        </div>
        <div class="page-header-middle">
            <p class="page-header-statement">Keep every biometric punch, credit only the scheduled time window, and review early arrivals plus late overtime in one report.</p>
        </div>
        <div class="page-header-right ms-auto">
            <div class="page-header-right-items d-flex"><div class="d-flex align-items-center gap-2">
                <a href="attendance.php" class="btn btn-outline-primary"><i class="feather-clock me-1"></i>Attendance DTR</a>
