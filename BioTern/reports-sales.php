...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>BioTern || Sales Report</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
...
<body>
    ...
    <main class="nxl-container">
        ...
        <footer class="footer">
            ...
            <p><span>By: <a target="_blank" href="https://wrapbootstrap.com/user/theme_ocean" target="_blank">theme_ocean</a></span> â€¢ <span>Distributed by: <a target="_blank" href="https://themewagon.com" target="_blank">ThemeWagon</a></span></p>
