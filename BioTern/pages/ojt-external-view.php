...
$internStmt = $conn->prepare("
    ...
    WHERE student_id = ? AND deleted_at IS NULL
      AND LOWER(TRIM(COALESCE(type, 'internal'))) = 'external'
...
$page_title = 'External Student View';
$page_body_class = 'page-ojt-external-view';
    ...
    <div class="nxl-content">
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">External Student View</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="homepage.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="ojt-external-list.php">External Students</a></li>
        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-lg-7">
                <div class="card"><div class="card-body">
                    <h5 class="mb-3">External OJT Information</h5>
                    <?php if ($internship): ?>
                        <dl class="row mb-0">
                    ...
                    <?php else: ?>
                        <p class="text-muted mb-0">No external internship record is attached to this student yet.</p>
                    <?php endif; ?>
                </div></div>
            </div>
        </div>
