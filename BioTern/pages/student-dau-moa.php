...
$stmt = $conn->prepare("SELECT * FROM dau_moa WHERE user_id = ? ORDER BY id DESC LIMIT 1");
if ($stmt) {
...
<body>
    <div class="page">
        ...
        <p>School Representative: <?php echo htmlspecialchars((string)($doc['school_representative'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
</body>
</html>
