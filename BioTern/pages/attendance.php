        ...
        <table>
            ...
            <tbody>
                <?php if (empty($attendances)): ?>
                    <tr><td colspan="11" class="text-center">No attendance records matched the current filters.</td></tr>
                <?php else: ?>
...
<div class="modal fade" id="viewAttendanceModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal fade" id="attendanceRowDetailsModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body attendance-actions-modal-body" id="attendanceRowDetailsBody"></div>
            </div>
        </div>
    </div>
