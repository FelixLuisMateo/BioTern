...
{
    $target = 'biometric-machine-bridge2.php';
    if ($params !== []) {
...
function machine_fetch_bridge_profile(mysqli $conn): array
{
    ...
    $res = $conn->query("SELECT * FROM biometric_bridge_profile WHERE profile_name = 'bridge_2' LIMIT 1");
...
$page_title = 'BioTern || Bridge 2 Machine Manager';
        ...
        <div class="page-header" data-phc-skip="1">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Bridge 2 Machine Manager</h5>
                </div>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="homepage.php">Home</a></li>
                    <li class="breadcrumb-item">Bridge 2 Machine Manager</li>
                </ul>
            </div>
                    ...
                    <div class="card-body p-0 collapse" id="machineRawLogsCollapse">
                        ...
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 px-3 py-3 border-top">
                            ...
                            <div class="d-flex gap-2">
                                <?php if ($rawLogPage > 1): ?>
                                    <a class="btn btn-sm btn-outline-primary" href="biometric-machine-bridge2.php?raw_page=<?php echo $rawLogPage - 1; ?>">Previous</a>
                                <?php endif; ?>
                                <?php if ($rawLogPage < $rawLogPages): ?>
                                    <a class="btn btn-sm btn-outline-primary" href="biometric-machine-bridge2.php?raw_page=<?php echo $rawLogPage + 1; ?>">Next</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
