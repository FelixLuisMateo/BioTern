...
$page_styles = [
    ...
    'assets/css/modules/documents/edit-moa-dau-template-page.css',
];
$page_scripts = [
...
<div class="main-content app-editor-main-content">
    <div class="topbar app-editor-topbar">
        ...
        <a class="btn btn-success" href="documents/document_moa.php">Back to MOA</a>
        ...
        <span id="msg" class="msg app-editor-status">Edit MOA template and click Save</span>
    </div>
