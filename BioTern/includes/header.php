...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo htmlspecialchars(header_asset_versioned_href('assets/css/state/popup-modal-scheme.css'), ENT_QUOTES, 'UTF-8'); ?>" />
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo htmlspecialchars(header_asset_versioned_href('assets/css/state/mobile-components-extended.css'), ENT_QUOTES, 'UTF-8'); ?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo htmlspecialchars(header_asset_versioned_href('assets/css/state/mobile-filter-actions-modal.css'), ENT_QUOTES, 'UTF-8'); ?>" />
