...
$nav_active_attendance = biotern_nav_any_active($nav_current_file, [
    'attendance.php', 'test-attendance.php', 'external-attendance.php', 'attendance-corrections.php', 'print_attendance.php',
...
$nav_active_ojt = biotern_nav_any_active($nav_current_file, [
    ...
    'ojt-internal-list.php', 'ojt-internal-masterlist.php', 'ojt-external-list.php',
]);
...
$nav_active_student_settings = biotern_nav_any_active($nav_current_file, [
    'notifications.php', 'account-settings.php', 'theme-customizer.php',
]);
            ...
            <ul class="nxl-navbar">
                ...
                <li class="nxl-item<?php echo biotern_nav_any_active($nav_current_file, ['student-profile.php', 'profile-details.php']) ? ' active' : ''; ?>">
                    <a href="profile-details.php" class="nxl-link">
                        ...
                        <span class="nxl-mtext">Profile Details</span>
                    </a>
                </li>
                <?php else: ?>
                ...
                <li class="nxl-item nxl-hasmenu<?php echo $nav_active_attendance ? ' active nxl-trigger' : ''; ?>">
                    <a href="javascript:void(0);" class="nxl-link">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item<?php echo biotern_nav_is_active('attendance-corrections.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="attendance-corrections.php">Attendance Corrections</a></li>
                    </ul>
                </li>
                ...
                <li class="nxl-item nxl-hasmenu<?php echo $nav_active_reports ? ' active nxl-trigger' : ''; ?>">
                    ...
                    <ul class="nxl-submenu">
                        ...
                        <li class="nxl-item<?php echo biotern_nav_any_active($nav_current_file, ['reports-dtr-manual-external-results.php']) || ($nav_current_file === 'reports-dtr-manual-student.php' && strtolower((string)($_GET['origin'] ?? '')) === 'external' && strtolower((string)($_GET['view'] ?? 'review')) === 'results') ? ' active' : ''; ?>"><a class="nxl-link" href="reports-dtr-manual-external-results.php">External DTR Results</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-attendance-anomalies.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-attendance-anomalies.php">Attendance Issues</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-hours-completion.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-hours-completion.php">Hours Completion</a></li>
                        <?php if ($nav_is_admin): ?>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-student-status.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-student-status.php">Student Status</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-section.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-section.php">Sections</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-department.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-department.php">Departments</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-company.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-company.php">Companies</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-evaluation.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-evaluation.php">Evaluations</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-unassigned-students.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-unassigned-students.php">Unassigned Students</a></li>
                        <li class="nxl-item<?php echo biotern_nav_is_active('reports-document.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="reports-document.php">Documents</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <?php if ($nav_student_track === 'internal'): ?>
                <li class="nxl-item<?php echo biotern_nav_any_active($nav_current_file, ['student-dtr.php', 'student-internal-dtr.php']) ? ' active' : ''; ?>">
                    <a href="student-internal-dtr.php" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-clock"></i></span>
                        <span class="nxl-mtext">Internal DTR</span>
                    </a>
                </li>
                ...
                <li class="nxl-item<?php echo biotern_nav_any_active($nav_current_file, ['student-external-dtr.php', 'external-biometric.php']) ? ' active' : ''; ?>">
                    <a href="external-biometric.php" class="nxl-link">
                        ...
                        <span class="nxl-mtext">External DTR</span>
                    </a>
                </li>
                <li class="nxl-item<?php echo biotern_nav_is_active('student-manual-dtr.php', $nav_current_file) ? ' active' : ''; ?>">
                    <a href="student-manual-dtr.php" class="nxl-link">
                ...
                <li class="nxl-item<?php echo biotern_nav_is_active('apps-notes.php', $nav_current_file) ? ' active' : ''; ?>">
                    <a href="apps-notes.php" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-edit-2"></i></span>
                        <span class="nxl-mtext">Notes</span>
                    </a>
                </li>
                <li class="nxl-item<?php echo biotern_nav_is_active('apps-storage.php', $nav_current_file) ? ' active' : ''; ?>">
                    <a href="apps-storage.php" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-hard-drive"></i></span>
                        <span class="nxl-mtext">Storage</span>
                    </a>
                </li>
                <li class="nxl-item<?php echo biotern_nav_is_active('apps-calendar.php', $nav_current_file) ? ' active' : ''; ?>">
                    <a href="apps-calendar.php" class="nxl-link">
                ...
                <li class="nxl-item nxl-hasmenu<?php echo $nav_active_system_logs ? ' active nxl-trigger' : ''; ?>">
                    <a href="javascript:void(0);" class="nxl-link">
                        <span class="nxl-micon"><i class="feather-activity"></i></span>
                        <span class="nxl-mtext">Logs & Audit</span><span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                    </a>
                    <ul class="nxl-submenu">
                ...
                <li class="nxl-item nxl-hasmenu<?php echo $nav_active_tools ? ' active nxl-trigger' : ''; ?>">
                    ...
                    <ul class="nxl-submenu">
                        <li class="nxl-item<?php echo biotern_nav_is_active('import-students-excel.php', $nav_current_file) ? ' active' : ''; ?>"><a class="nxl-link" href="import-students-excel.php">Student's Masterlist Import/Export</a></li>
