...
<?php if (!$page_is_public): ?>
    ...
    <?php endif; ?>
    <!-- Unified toast container for desktop/mobile system-style notifications -->
    <div id="bioternToastContainer" class="biotern-system-toast-stack" aria-live="polite" aria-atomic="true"></div>
<?php endif; ?>
