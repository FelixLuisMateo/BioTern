...
if ($student_id <= 0) {
    header('Location: idnotfound-404.php?source=students-external-dtr&id=' . urlencode($student_id));
    exit;
}
...
while ($row = $att_res->fetch_assoc()) {
    ...
    $records_by_date[$dateKey] = $row;
    $month_total_hours += (float)($row['total_hours'] ?? 0);
}
$att_stmt->close();

$present_days = count($records_by_date);
...
$page_title = 'BioTern || Student External DTR';
    ...
    <div class="nxl-content">
        <div class="page-header app-students-dtr-page-header">
            <div class="page-header-left d-flex align-items-center">
                <div class="page-header-title">
                    <h5 class="m-b-10">Student External Daily Time Record</h5>
                </div>
                <ul class="breadcrumb">
            ...
            <div class="page-header-right ms-auto">
                <div class="d-flex align-items-center gap-2">
                    <a href="students-external-dtr.php?id=<?php echo intval($student_id); ?>&month=<?php echo h($prev_month_input); ?>" class="btn btn-light-brand">
        ...
        <div class="main-content">
                ...
                <div class="card-body">
                    <div class="toolbar app-students-dtr-toolbar">
                        <div class="app-students-dtr-hero-copy">
                            <p class="app-students-dtr-overline">External Attendance Overview</p>
                            <h5 class="mb-1"><?php echo h($student_name); ?></h5>
                            <p class="app-students-dtr-copy-note mb-0">Review external attendance logs, selected range totals, and printable date coverage in the same DTR layout.</p>
                        ...
                        <div class="app-students-dtr-toolbar-side">
                            ...
                            <div class="app-students-dtr-hours-chip">
                                <p class="app-students-dtr-hours-chip-label mb-0">External Hours Snapshot</p>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3 col-6"><div class="dtr-summary-card app-students-dtr-summary-card"><div class="dtr-summary-label app-students-dtr-summary-label">Logged In Range</div><div class="dtr-summary-value app-students-dtr-summary-value"><?php echo h(fmt_hours_hm($month_total_hours)); ?></div></div></div>
            </div>

            <div class="card stretch stretch-full">
                <div class="card-header"><h6 class="mb-0">External Attendance History</h6></div>
