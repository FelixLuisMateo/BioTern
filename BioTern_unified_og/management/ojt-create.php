                                ...
                                <div class="row">
                                    <div class="col-lg-4 mb-4">
                                        ...
                                        <select class="form-control" data-select2-selector="status">
                                            ...
                                            <option value="indigo" data-bg="bg-indigo">Student</option>
                                        </select>
                                    </div>
                                    <div class="col-lg-4 mb-4">
                                ...
                                <div class="row mb-4 align-items-center app-ojt-create-info-row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" data-select2-selector="country">
                                            ...
                                            <option data-country="ax">Ãƒâ€¦land Islands</option>
                                            ...
                                            <option data-country="ci">CÃƒÂ´te d'Ivoire</option>
                                            <option data-country="hr">Croatia</option>
                                            <option data-country="cu">Cuba</option>
                                            <option data-country="cu">CuraÃƒÂ§ao</option>
                                            ...
                                            <option data-country="st">SÃƒÂ£o TomÃƒÂ© & PrÃƒÂ­ncipe</option>
                                ...
                                <div class="row mb-4 align-items-center app-ojt-create-info-row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" data-select2-selector="language" multiple>
                                            ...
                                            <option data-language="bg-cyan">Amharic - Ã¡Å Â Ã¡Ë†â€ºÃ¡Ë†Â­Ã¡Å â€º</option>
                                            <option data-language="bg-green">Arabic - Ã˜Â§Ã™â€žÃ˜Â¹Ã˜Â±Ã˜Â¨Ã™Å Ã˜Â©</option>
                                            <option data-language="bg-black">Aragonese - aragonÃƒÂ©s</option>
                                            <option data-language="bg-teal">Armenian - Ã•Â°Ã•Â¡Ã•ÂµÃ•Â¥Ã–â‚¬Ã•Â¥Ã•Â¶</option>
                                            <option data-language="bg-success">Asturian - asturianu</option>
                                            <option data-language="bg-cyan">Azerbaijani - azÃ‰â„¢rbaycan dili</option>
                                            <option data-language="bg-indigo">Basque - euskara</option>
                                            <option data-language="bg-teal">Belarusian - ÃÂ±ÃÂµÃÂ»ÃÂ°Ã‘â‚¬Ã‘Æ’Ã‘ÂÃÂºÃÂ°Ã‘Â</option>
                                            <option data-language="bg-black">Bengali - Ã Â¦Â¬Ã Â¦Â¾Ã Â¦â€šÃ Â¦Â²Ã Â¦Â¾</option>
                                            <option data-language="bg-green">Bosnian - bosanski</option>
                                            <option data-language="bg-primary">Breton - brezhoneg</option>
                                            <option data-language="bg-warning">Bulgarian - ÃÂ±Ã‘Å ÃÂ»ÃÂ³ÃÂ°Ã‘â‚¬Ã‘ÂÃÂºÃÂ¸</option>
                                            <option data-language="bg-teal">Catalan - catalÃƒÂ </option>
                                            <option data-language="bg-black">Central Kurdish - ÃšÂ©Ã™Ë†Ã˜Â±Ã˜Â¯Ã›Å’ (Ã˜Â¯Ã›â€¢Ã˜Â³Ã˜ÂªÃ™â€ Ã™Ë†Ã˜Â³Ã›Å’ Ã˜Â¹Ã›â€¢Ã˜Â±Ã›â€¢Ã˜Â¨Ã›Å’)</option>
                                            <option data-language="bg-green">Chinese - Ã¤Â¸Â­Ã¦â€“â€¡</option>
                                            <option data-language="bg-cyan">Chinese (Hong Kong) - Ã¤Â¸Â­Ã¦â€“â€¡Ã¯Â¼Ë†Ã©Â¦â„¢Ã¦Â¸Â¯Ã¯Â¼â€°</option>
                                            <option data-language="bg-primary">Chinese (Simplified) - Ã¤Â¸Â­Ã¦â€“â€¡Ã¯Â¼Ë†Ã§Â®â‚¬Ã¤Â½â€œÃ¯Â¼â€°</option>
                                            <option data-language="bg-danger">Chinese (Traditional) - Ã¤Â¸Â­Ã¦â€“â€¡Ã¯Â¼Ë†Ã§Â¹ÂÃ©Â«â€Ã¯Â¼â€°</option>
                                            <option data-language="bg-cyan">Corsican</option>
                                            <option data-language="bg-black">Croatian - hrvatski</option>
                                            <option data-language="bg-warning">Czech - Ã„ÂeÃ…Â¡tina</option>
                                            ...
                                            <option data-language="bg-primary">Faroese - fÃƒÂ¸royskt</option>
                                            <option data-language="bg-black">Filipino</option>
                                            <option data-language="bg-cyan">Finnish - suomi</option>
                                            <option data-language="bg-primary">French - franÃƒÂ§ais</option>
                                            <option data-language="bg-success">French (Canada) - franÃƒÂ§ais (Canada)</option>
                                            <option data-language="bg-warning">French (France) - franÃƒÂ§ais (France)</option>
                                            <option data-language="bg-black">French (Switzerland) - franÃƒÂ§ais (Suisse)</option>
                                            <option data-language="bg-primary">Galician - galego</option>
                                            <option data-language="bg-teal">Georgian - Ã¡Æ’Â¥Ã¡Æ’ÂÃ¡Æ’Â Ã¡Æ’â€”Ã¡Æ’Â£Ã¡Æ’Å¡Ã¡Æ’Ëœ</option>
                                            <option data-language="bg-black">German - Deutsch</option>
                                            <option data-language="bg-green">German (Austria) - Deutsch (Ãƒâ€“sterreich)</option>
                                            ...
                                            <option data-language="bg-primary">Greek - ÃŽâ€¢ÃŽÂ»ÃŽÂ»ÃŽÂ·ÃŽÂ½ÃŽÂ¹ÃŽÂºÃŽÂ¬</option>
                                            <option data-language="bg-green">Guarani</option>
                                            <option data-language="bg-teal">Gujarati - Ã Âªâ€”Ã Â«ÂÃ ÂªÅ“Ã ÂªÂ°Ã ÂªÂ¾Ã ÂªÂ¤Ã Â«â‚¬</option>
                                            <option data-language="bg-success">Hausa</option>
                                            <option data-language="bg-primary">Hawaiian - ÃŠÂ»Ã…Å’lelo HawaiÃŠÂ»i</option>
                                            <option data-language="bg-cyan">Hebrew - Ã—Â¢Ã—â€˜Ã—Â¨Ã—â„¢Ã—Âª</option>
                                            <option data-language="bg-warning">Hindi - Ã Â¤Â¹Ã Â¤Â¿Ã Â¤Â¨Ã Â¥ÂÃ Â¤Â¦Ã Â¥â‚¬</option>
                                            <option data-language="bg-green">Hungarian - magyar</option>
                                            <option data-language="bg-black">Icelandic - ÃƒÂ­slenska</option>
                                            ...
                                            <option data-language="bg-indigo">Japanese - Ã¦â€”Â¥Ã¦Å“Â¬Ã¨ÂªÅ¾</option>
                                            <option data-language="bg-primary">Kannada - Ã Â²â€¢Ã Â²Â¨Ã Â³ÂÃ Â²Â¨Ã Â²Â¡</option>
                                            <option data-language="bg-cyan">Kazakh - Ã’â€ºÃÂ°ÃÂ·ÃÂ°Ã’â€º Ã‘â€šÃ‘â€“ÃÂ»Ã‘â€“</option>
                                            <option data-language="bg-black">Khmer - Ã¡Å¾ÂÃ¡Å¸â€™Ã¡Å¾ËœÃ¡Å¸â€šÃ¡Å¾Å¡</option>
                                            <option data-language="bg-primary">Korean - Ã­â€¢Å“ÃªÂµÂ­Ã¬â€“Â´</option>
                                            <option data-language="bg-warning">Kurdish - KurdÃƒÂ®</option>
                                            <option data-language="bg-cyan">Kyrgyz - ÃÂºÃ‘â€¹Ã‘â‚¬ÃÂ³Ã‘â€¹ÃÂ·Ã‘â€¡ÃÂ°</option>
                                            <option data-language="bg-danger">Lao - Ã ÂºÂ¥Ã ÂºÂ²Ã ÂºÂ§</option>
                                            <option data-language="bg-primary">Latin</option>
                                            <option data-language="bg-orange">Latvian - latvieÃ…Â¡u</option>
                                            <option data-language="bg-green">Lingala - lingÃƒÂ¡la</option>
                                            <option data-language="bg-black">Lithuanian - lietuviÃ…Â³</option>
                                            <option data-language="bg-primary">Macedonian - ÃÂ¼ÃÂ°ÃÂºÃÂµÃÂ´ÃÂ¾ÃÂ½Ã‘ÂÃÂºÃÂ¸</option>
                                            <option data-language="bg-indigo">Malay - Bahasa Melayu</option>
                                            <option data-language="bg-green">Malayalam - Ã Â´Â®Ã Â´Â²Ã Â´Â¯Ã Â´Â¾Ã Â´Â³Ã Â´â€š</option>
                                            <option data-language="bg-cyan">Maltese - Malti</option>
                                            <option data-language="bg-teal">Marathi - Ã Â¤Â®Ã Â¤Â°Ã Â¤Â¾Ã Â¤Â Ã Â¥â‚¬</option>
                                            <option data-language="bg-primary">Mongolian - ÃÂ¼ÃÂ¾ÃÂ½ÃÂ³ÃÂ¾ÃÂ»</option>
                                            <option data-language="bg-danger">Nepali - Ã Â¤Â¨Ã Â¥â€¡Ã Â¤ÂªÃ Â¤Â¾Ã Â¤Â²Ã Â¥â‚¬</option>
                                            <option data-language="bg-green">Norwegian - norsk</option>
                                            <option data-language="bg-warning">Norwegian BokmÃƒÂ¥l - norsk bokmÃƒÂ¥l</option>
                                            <option data-language="bg-primary">Norwegian Nynorsk - nynorsk</option>
                                            <option data-language="bg-success">Occitan</option>
                                            <option data-language="bg-cyan">Oriya - Ã Â¬â€œÃ Â¬Â¡Ã Â¬Â¼Ã Â¬Â¿Ã Â¬â€ </option>
                                            <option data-language="bg-black">Oromo - Oromoo</option>
                                            <option data-language="bg-danger">Pashto - Ã™Â¾ÃšÅ¡Ã˜ÂªÃ™Ë†</option>
                                            <option data-language="bg-green">Persian - Ã™ÂÃ˜Â§Ã˜Â±Ã˜Â³Ã›Å’</option>
                                            <option data-language="bg-primary">Polish - polski</option>
                                            <option data-language="bg-teal">Portuguese - portuguÃƒÂªs</option>
                                            <option data-language="bg-danger">Portuguese (Brazil) - portuguÃƒÂªs (Brasil)</option>
                                            <option data-language="bg-black">Portuguese (Portugal) - portuguÃƒÂªs (Portugal)</option>
                                            <option data-language="bg-green">Punjabi - Ã Â¨ÂªÃ Â©Â°Ã Â¨Å“Ã Â¨Â¾Ã Â¨Â¬Ã Â©â‚¬</option>
                                            <option data-language="bg-indigo">Quechua</option>
                                            <option data-language="bg-success">Romanian - romÃƒÂ¢nÃ„Æ’</option>
                                            <option data-language="bg-warning">Romanian (Moldova) - romÃƒÂ¢nÃ„Æ’ (Moldova)</option>
                                            <option data-language="bg-primary">Romansh - rumantsch</option>
                                            <option data-language="bg-danger">Russian - Ã‘â‚¬Ã‘Æ’Ã‘ÂÃ‘ÂÃÂºÃÂ¸ÃÂ¹</option>
                                            <option data-language="bg-green">Scottish Gaelic</option>
                                            <option data-language="bg-orange">Serbian - Ã‘ÂÃ‘â‚¬ÃÂ¿Ã‘ÂÃÂºÃÂ¸</option>
                                            ...
                                            <option data-language="bg-black">Sinhala - Ã Â·Æ’Ã Â·â€™Ã Â¶â€šÃ Â·â€žÃ Â¶Â½</option>
                                            <option data-language="bg-warning">Slovak - slovenÃ„Âina</option>
                                            <option data-language="bg-danger">Slovenian - slovenÃ…Â¡Ã„Âina</option>
                                            <option data-language="bg-green">Somali - Soomaali</option>
                                            <option data-language="bg-primary">Southern Sotho</option>
                                            <option data-language="bg-orange">Spanish - espaÃƒÂ±ol</option>
                                            <option data-language="bg-indigo">Spanish (Argentina) - espaÃƒÂ±ol (Argentina)</option>
                                            <option data-language="bg-green">Spanish (Latin America) - espaÃƒÂ±ol (LatinoamÃƒÂ©rica)</option>
                                            <option data-language="bg-cyan">Spanish (Mexico) - espaÃƒÂ±ol (MÃƒÂ©xico)</option>
                                            <option data-language="bg-black">Spanish (Spain) - espaÃƒÂ±ol (EspaÃƒÂ±a)</option>
                                            <option data-language="bg-success">Spanish (United States) - espaÃƒÂ±ol (Estados Unidos)</option>
                                            ...
                                            <option data-language="bg-cyan">Tajik - Ã‘â€šÃÂ¾Ã’Â·ÃÂ¸ÃÂºÃ“Â£</option>
                                            <option data-language="bg-warning">Tamil - Ã Â®Â¤Ã Â®Â®Ã Â®Â¿Ã Â®Â´Ã Â¯Â</option>
                                            <option data-language="bg-primary">Tatar</option>
                                            <option data-language="bg-success">Telugu - Ã Â°Â¤Ã Â±â€ Ã Â°Â²Ã Â±ÂÃ Â°â€”Ã Â±Â</option>
                                            <option data-language="bg-black">Thai - Ã Â¹â€žÃ Â¸â€”Ã Â¸Â¢</option>
                                            <option data-language="bg-green">Tigrinya - Ã¡â€°ÂµÃ¡Å’ÂÃ¡Ë†Â­Ã¡Å â€º</option>
                                            <option data-language="bg-teal">Tongan - lea fakatonga</option>
                                            <option data-language="bg-primary">Turkish - TÃƒÂ¼rkÃƒÂ§e</option>
                                            <option data-language="bg-danger">Turkmen</option>
                                            <option data-language="bg-indigo">Twi</option>
                                            <option data-language="bg-black">Ukrainian - Ã‘Æ’ÃÂºÃ‘â‚¬ÃÂ°Ã‘â€”ÃÂ½Ã‘ÂÃ‘Å’ÃÂºÃÂ°</option>
                                            <option data-language="bg-green">Urdu - Ã˜Â§Ã˜Â±Ã˜Â¯Ã™Ë†</option>
                                            <option data-language="bg-cyan">Uyghur</option>
                                            <option data-language="bg-primary">Uzbek - oÃ¢â‚¬Ëœzbek</option>
                                            <option data-language="bg-success">Vietnamese - TiÃ¡ÂºÂ¿ng ViÃ¡Â»â€¡t</option>
                                            ...
                                            <option data-language="bg-green">Yoruba - ÃƒË†dÃƒÂ¨ YorÃƒÂ¹bÃƒÂ¡</option>
                                ...
                                <div class="row mb-4 align-items-center app-ojt-create-info-row">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" data-select2-selector="currency">
                                            <option data-currency="af">AFN - Afghan Afghani - Ã˜â€¹</option>
                                            <option data-currency="al">ALL - Albanian Lek - Lek</option>
                                            <option data-currency="dz">DZD - Algerian Dinar - Ã˜Â¯Ã˜Â¬</option>
                                            <option data-currency="ao">AOA - Angolan Kwanza - Kz</option>
                                            <option data-currency="ar">ARS - Argentine Peso - $</option>
                                            <option data-currency="am">AMD - Armenian Dram - Ã–Â</option>
                                            <option data-currency="aw">AWG - Aruban Florin - Ã†â€™</option>
                                            ...
                                            <option data-currency="bh">BHD - Bahraini Dinar - .Ã˜Â¯.Ã˜Â¨</option>
                                            <option data-currency="bd">BDT - Bangladeshi Taka - Ã Â§Â³</option>
                                            ...
                                            <option data-currency="bt">BTC - Bitcoin - Ã Â¸Â¿</option>
                                            ...
                                            <option data-currency="gb">GBP - British Pound Sterling - Ã‚Â£</option>
                                            <option data-currency="bn">BND - Brunei Dollar - B$</option>
                                            <option data-currency="bg">BGN - Bulgarian Lev - Ãâ€ºÃÂ².</option>
                                            ...
                                            <option data-currency="fr">XPF - CFP Franc - Ã¢â€šÂ£</option>
                                            <option data-currency="cl">CLP - Chilean Peso - $</option>
                                            <option data-currency="cn">CNY - Chinese Yuan - Ã‚Â¥</option>
                                            ...
                                            <option data-currency="cr">CRC - Costa Rican ColÃƒÆ’Ã‚Â³n - Ã¢â€šÂ¡</option>
                                            <option data-currency="hr">HRK - Croatian Kuna - kn</option>
                                            <option data-currency="cu">CUC - Cuban Convertible Peso - $, CUC</option>
                                            <option data-currency="cz">CZK - Czech Republic Koruna - KÃ„Â</option>
                                            ...
                                            <option data-currency="eg">EGP - Egyptian Pound - Ã˜Â¬.Ã™â€¦</option>
                                            ...
                                            <option data-currency="eu">EUR - Euro - Ã¢â€šÂ¬</option>
                                            <option data-currency="fk">FKP - Falkland Islands Pound - Ã‚Â£</option>
                                            <option data-currency="fj">FJD - Fijian Dollar - FJ$</option>
                                            <option data-currency="gm">GMD - Gambian Dalasi - D</option>
                                            <option data-currency="ge">GEL - Georgian Lari - Ã¡Æ’Å¡</option>
                                            <option data-currency="de">DEM - German Mark - DM</option>
                                            <option data-currency="gh">GHS - Ghanaian Cedi - GHÃ¢â€šÂµ</option>
                                            <option data-currency="gi">GIP - Gibraltar Pound - Ã‚Â£</option>
                                            <option data-currency="gr">GRD - Greek Drachma - Ã¢â€šÂ¯, ÃŽâ€ÃÂÃâ€¡, ÃŽâ€ÃÂ</option>
                                            ...
                                            <option data-currency="is">ISK - Icelandic KrÃƒÆ’Ã‚Â³na - kr</option>
                                            <option data-currency="in">INR - Indian Rupee - Ã¢â€šÂ¹</option>
                                            <option data-currency="id">IDR - Indonesian Rupiah - Rp</option>
                                            <option data-currency="ir">IRR - Iranian Rial - Ã¯Â·Â¼</option>
                                            <option data-currency="iq">IQD - Iraqi Dinar - Ã˜Â¯.Ã˜Â¹</option>
                                            <option data-currency="il">ILS - Israeli New Sheqel - Ã¢â€šÂª</option>
                                            <option data-currency="it">ITL - Italian Lira - L,Ã‚Â£</option>
                                            <option data-currency="jm">JMD - Jamaican Dollar - J$</option>
                                            <option data-currency="jp">JPY - Japanese Yen - Ã‚Â¥</option>
                                            <option data-currency="jo">JOD - Jordanian Dinar - Ã˜Â§.Ã˜Â¯</option>
                                            <option data-currency="kz">KZT - Kazakhstani Tenge - ÃÂ»ÃÂ²</option>
                                            <option data-currency="ke">KES - Kenyan Shilling - KSh</option>
                                            <option data-currency="kw">KWD - Kuwaiti Dinar - Ã™Æ’.Ã˜Â¯</option>
                                            <option data-currency="kg">KGS - Kyrgystani Som - ÃÂ»ÃÂ²</option>
                                            <option data-currency="la">LAK - Laotian Kip - Ã¢â€šÂ­</option>
                                            <option data-currency="lv">LVL - Latvian Lats - Ls</option>
                                            <option data-currency="lb">LBP - Lebanese Pound - Ã‚Â£</option>
                                            <option data-currency="ls">LSL - Lesotho Loti - L</option>
                                            <option data-currency="lr">LRD - Liberian Dollar - $</option>
                                            <option data-currency="ly">LYD - Libyan Dinar - Ã˜Â¯.Ã™â€ž</option>
                                            <option data-currency="lt">LTL - Lithuanian Litas - Lt</option>
                                            <option data-currency="mo">MOP - Macanese Pataca - $</option>
                                            <option data-currency="mk">MKD - Macedonian Denar - ÃÂ´ÃÂµÃÂ½</option>
                                            ...
                                            <option data-currency="mu">MUR - Mauritian Rupee - Ã¢â€šÂ¨</option>
                                            <option data-currency="mx">MXN - Mexican Peso - $</option>
                                            <option data-currency="md">MDL - Moldovan Leu - L</option>
                                            <option data-currency="mn">MNT - Mongolian Tugrik - Ã¢â€šÂ®</option>
                                            ...
                                            <option data-currency="np">NPR - Nepalese Rupee - Ã¢â€šÂ¨</option>
                                            <option data-currency="nl">ANG - Netherlands Antillean Guilder - Ã†â€™</option>
                                            <option data-currency="tw">TWD - New Taiwan Dollar - $</option>
                                            <option data-currency="nz">NZD - New Zealand Dollar - $</option>
                                            <option data-currency="ni">NIO - Nicaraguan CÃƒÆ’Ã‚Â³rdoba - C$</option>
                                            <option data-currency="ng">NGN - Nigerian Naira - Ã¢â€šÂ¦</option>
                                            <option data-currency="kp">KPW - North Korean Won - Ã¢â€šÂ©</option>
                                            <option data-currency="no">NOK - Norwegian Krone - kr</option>
                                            <option data-currency="om">OMR - Omani Rial - .Ã˜Â¹.Ã˜Â±</option>
                                            <option data-currency="pk">PKR - Pakistani Rupee - Ã¢â€šÂ¨</option>
                                            <option data-currency="pa">PAB - Panamanian Balboa - B/.</option>
                                            <option data-currency="pg">PGK - Papua New Guinean Kina - K</option>
                                            <option data-currency="py">PYG - Paraguayan Guarani - Ã¢â€šÂ²</option>
                                            <option data-currency="pe">PEN - Peruvian Nuevo Sol - S/.</option>
                                            <option data-currency="ph">PHP - Philippine Peso - Ã¢â€šÂ±</option>
                                            <option data-currency="pl">PLN - Polish Zloty - zÃ…â€š</option>
                                            <option data-currency="qa">QAR - Qatari Rial - Ã™â€š.Ã˜Â±</option>
                                            <option data-currency="ro">RON - Romanian Leu - lei</option>
                                            <option data-currency="ru">RUB - Russian Ruble - Ã¢â€šÂ½</option>
                                            <option data-currency="rw">RWF - Rwandan Franc - FRw</option>
                                            <option data-currency="sv">SVC - Salvadoran ColÃƒÆ’Ã‚Â³n - Ã¢â€šÂ¡</option>
                                            <option data-currency="ws">WST - Samoan Tala - SAT</option>
                                            <option data-currency="sa">SAR - Saudi Riyal - Ã¯Â·Â¼</option>
                                            ...
                                            <option data-currency="kr">KRW - South Korean Won - Ã¢â€šÂ©</option>
                                            <option data-currency="lk">LKR - Sri Lankan Rupee - Rs</option>
                                            <option data-currency="sh">SHP - St. Helena Pound - Ã‚Â£</option>
                                            <option data-currency="sd">SDG - Sudanese Pound - .Ã˜Â³.Ã˜Â¬</option>
                                            ...
                                            <option data-currency="st">STD - SÃƒÂ£o TomÃƒÂ© and PrÃƒÂ­ncipe Dobra - Db</option>
                                            <option data-currency="tj">TJS - Tajikistani Somoni - SM</option>
                                            <option data-currency="tz">TZS - Tanzanian Shilling - TSh</option>
                                            <option data-currency="th">THB - Thai Baht - Ã Â¸Â¿</option>
                                            <option data-currency="to">TOP - Tongan pa'anga - $</option>
                                            <option data-currency="tt">TTD - Trinidad & Tobago Dollar - $</option>
                                            <option data-currency="tn">TND - Tunisian Dinar - Ã˜Âª.Ã˜Â¯</option>
                                            <option data-currency="tr">TRY - Turkish Lira - Ã¢â€šÂº</option>
                                            <option data-currency="tm">TMT - Turkmenistani Manat - T</option>
                                            <option data-currency="ug">UGX - Ugandan Shilling - USh</option>
                                            <option data-currency="ua">UAH - Ukrainian Hryvnia - Ã¢â€šÂ´</option>
                                            <option data-currency="ae">AED - United Arab Emirates Dirham - Ã˜Â¥.Ã˜Â¯</option>
                                            <option data-currency="uy">UYU - Uruguayan Peso - $</option>
                                            <option data-currency="us" selected>USD - US Dollar - $</option>
                                            <option data-currency="uz">UZS - Uzbekistan Som - ÃÂ»ÃÂ²</option>
                                            <option data-currency="vu">VUV - Vanuatu Vatu - VT</option>
                                            <option data-currency="ve">VEF - Venezuelan BolÃƒÆ’Ã‚Â­var - Bs</option>
                                            <option data-currency="vn">VND - Vietnamese Dong - Ã¢â€šÂ«</option>
                                            <option data-currency="ye">YER - Yemeni Rial - Ã¯Â·Â¼</option>
